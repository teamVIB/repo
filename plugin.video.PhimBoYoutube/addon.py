...
youtube_api_key = switching_key()


def CATEGORIES():
		addDIR('[COLOR blue]Phim Bo Hong Kong[/COLOR]','url',10,art + 'hk.png')
		addDIR('[COLOR blue]Phim Bo Han Quoc[/COLOR]','url',11,art + 'hq.png')
		addDIR('[COLOR blue]Phim Bo Trung Quoc[/COLOR]','url',12,art + 'tq.png')
		addDIR('[COLOR blue]Phim Bo Dai Loan[/COLOR]','url',13,art + 'tw.png')
		addDIR('[COLOR blue]Phim Bo An Do[/COLOR]','url',14,art + 'ad.png')
		addDIR('[COLOR blue]Phim Bo Thai Lan[/COLOR]','url',15,art + 'tl.png')
		addDIR('[COLOR blue]Phim Bo Nhat Ban[/COLOR]','url',17,art + 'nb.png')
		addDIR('[COLOR blue]Phim Bo Viet Nam[/COLOR]','url',18,art + 'vn.png')
...
def build_dir(keyword, mode, page):
		if page != 1:
			#url_api = 'https://www.googleapis.com/youtube/v3/search?part=id,snippet&type=playlist&maxResults=50&q='+keyword+'&key='+youtube_api_key +'&pageToken='+token
			url_api = "https://raw.githubusercontent.com/tranduc33/youtubeapi-data/master/phim/"+keyword+"/"+token+".txt"
		else:
			#url_api = 'https://www.googleapis.com/youtube/v3/search?part=id,snippet&type=playlist&maxResults=50&q='+keyword+'&type=playlist&maxResults=50&key='+youtube_api_key
			url_api = "https://raw.githubusercontent.com/tranduc33/youtubeapi-data/master/phim/"+keyword+"/first.txt"
...
if mode==None or url==None or len(url)<1:
		...
		return_youtubevideos(name,url,token,page,youtube_api_key, keyword)
