...
#youtube
channel_id = "UCzMVH2jEyEwXPBvyht8xQNw"
key = []


#youtube_api_key = str(switching_key()) #If you fork this addon please register another api key (https://developers.google.com/youtube/android/player/register)
#youtube channel
